...
local SETTINGS_KEYS = {
    ...
    "dungeonGuideAutoMarkEnabled", "dungeonGuidePoint", "dungeonGuideRelPoint",
    "dungeonGuideX", "dungeonGuideY",
...
local SETTINGS_TYPES = {
    ...
    dungeonGuideAutoMarkEnabled = "boolean", dungeonGuidePoint = "string",
