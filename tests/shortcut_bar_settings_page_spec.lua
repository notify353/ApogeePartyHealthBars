...
function ApogeePartyHealthBars_ActionSettingsComponents.LayoutActionList(list, visibleRows)
...
dofile("Settings/ShortcutBarSettingsPage.lua")
local config = ApogeePartyHealthBars_ShortcutBarSettingsPage
