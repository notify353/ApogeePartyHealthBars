...
- After approval, create and push an annotated `vX.Y.Z` tag, monitor the release workflow to completion, and verify the matching GitHub and CurseForge releases.
