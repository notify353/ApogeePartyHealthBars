...
local function applyOutOfCombatState()
    ...
    D.SettingsSurfaces.SetSurfaceChromeShown("cleanse", configurationVisible)
...
function Watch.Initialize(deps)
    ...
    for _, key in ipairs({
        "Auras", "PlayerSpells", "SecureFrames", "SettingsSurfaces", "Now",
    }) do
...
function Watch.Build()
    ...
    D.SettingsSurfaces.Register("cleanse", frame)
