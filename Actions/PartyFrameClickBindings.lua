...
ApogeePartyHealthBars_PartyFrameClickBindings = {}
local B = ApogeePartyHealthBars_PartyFrameClickBindings
local D
...
local function ApplyPartyFrameClickBindings(castBtn, unitId, active, visibilityFrame)
