...
mob("kraulBat", 4538, "Kraul Bat", "none", 160,
    ...
    "Beast", "Hibernate, Scare Beast, roots, slows, and other beast control work.")
mob("wardKeeper", 4625, "Death's Head Ward Keeper", "none", 170,
    "ward trigger; kill both to lower the barrier",
    "The two passive keepers are the lock on Agathelos's ward, so both must die before the tunnel opens.",
    {},
    "After the Seer and Guardians are dead, kill both Ward Keepers and wait for the barrier to fall.",
    "Humanoid", "Do not crowd-control them; both Ward Keepers must die to open the route.")
...
mob("earthcallerHalmgar", 4842, "Earthcaller Halmgar", "circle", 240,
    ...
    "Humanoid", "Interrupt Lightning Bolt and Banish the summoned Earth Rumbler when available.", {}, true)
...
mob("agathelos", 4422, "Agathelos the Raging", "circle", 260,
    "boss; stay in melee range and prepare for Enrage",
    "Rushing Charge punishes players who stand away from the boss, and Enrage creates the sharpest tank damage.",
    { "Rushing Charge", "Enrage" },
    "Stay in melee range and save mitigation and healing cooldowns for low-health Enrage.",
    "Beast", "Boss control is unreliable; use mitigation.", {}, true)
    ...
    sections = {
        ...
        },
        {
            ...
            entries = {
                ...
                "wardKeeper", "earthcallerHalmgar", "blindHunter", "agathelos",
                "charlgaRazorflank",
            },
            rules = {
