...
local SETTINGS_TYPES = {
    ...
    targetHudPoint = "string", targetHudRelPoint = "string",
    targetHudX = "number", targetHudY = "number",
    targetEffectHudPoint = "string", targetEffectHudRelPoint = "string",
    targetEffectHudX = "number", targetEffectHudY = "number",
    dotHudPoint = "string", dotHudRelPoint = "string", dotHudX = "number", dotHudY = "number",
