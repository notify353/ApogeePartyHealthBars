...
mob("defiasInsurgent", 1715, "Defias Insurgent", "skull", 20,
    ...
    { "Battle Shout", "Demoralizing Shout", "Low-health fleeing" },
...
mob("defiasConvict", 1711, "Defias Convict", "cross", 30,
    ...
    { "Backhand", "Infected Wound", "Rend", "Low-health fleeing" },
...
mob("defiasCaptive", 1707, "Defias Captive", "none", 40,
    ...
    { "Backstab", "Infected Wound", "Low-health fleeing" },
...
mob("targorr", 1696, "Targorr the Dread", "circle", 100,
    ...
    "Humanoid", "Boss control is unreliable; use mitigation and stuns only when accepted.",
...
mob("kamDeepfury", 1666, "Kam Deepfury", "circle", 110,
    ...
    { "Defensive Stance", "Improved Blocking", "Shield Slam", "Shield Wall" },
    "Control or kill nearby Defias, keep healing ready for a tank stun, and maintain steady damage through his defenses.",
    "Humanoid", "Boss control is unreliable; disarm or stuns may work only when accepted.",
...
mob("dextrenWard", 1663, "Dextren Ward", "circle", 100,
    ...
    { "Intimidating Shout", "Battle Shout", "Heroic Strike" },
...
mob("hamhock", 1717, "Hamhock", "circle", 100,
    ...
    { "Chain Lightning", "Bloodlust", "Two Defias adds" },
