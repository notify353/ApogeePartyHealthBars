...
- `SettingsUI`, `LoadoutsSettingsPage`: compact fixed-size settings-window shell, five task-group navigation, contextual page registry, multi-page selectors, single-page headings, native character loadout management, Settings-wide preview activation, and cross-page refresh routing
