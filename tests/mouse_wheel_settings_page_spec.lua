...
dofile("Settings/MouseWheelSettingsPage.lua")
local config = ApogeePartyHealthBars_MouseWheelSettingsPage
...
assert(droppedFeature == "mouseWheel" and droppedSlot == "normalDown" and droppedLayout == "base",
