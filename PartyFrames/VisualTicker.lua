...
local function OnUpdate(_, elapsed)
    ...
    if rangeTimer <= 0 then
        ...
        if D.TargetEffectTracker then D.TargetEffectTracker.Refresh(false) end
    end
...
function V.Initialize(deps)
    for _, key in ipairs({
        ...
        "ShortcutBar", "MouseWheelActions", "KeyboardActions", "MouseButtonActions", "ConsumableBar", "Threat",
    }) do
