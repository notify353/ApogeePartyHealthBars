...
local SETTINGS_KEYS = {
    ...
    "threatAwarenessEnabled", "threatAwarenessMode",
    ...
    "abilityCooldownsEnabled", "abilityCooldownOverrides", "abilityCooldownPriority",
...
local ORDERED_COLLECTIONS = {
    bindings = true, shortcuts = true, slots = true,
    targetEffectPriority = true, abilityCooldownPriority = true,
}
local SETTINGS_TYPES = {
    ...
    abilityCooldownsEnabled = "boolean", abilityCooldownOverrides = "table",
    abilityCooldownPriority = "table",
    ...
    dungeonGuideAutoMarkEnabled = "boolean",
