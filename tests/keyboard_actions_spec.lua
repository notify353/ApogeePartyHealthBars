...
dofile("Actions/Keyboard/KeyboardData.lua")
...
for _, slot in ipairs(data.SLOTS) do
    ...
    assert(ApogeePartyHealthBars_S.charSv.keyboardActions.ownership["2"][slot.id].previousAction
        == expectedPrevious[slot.key], "Keys did not snapshot " .. slot.key)
end

local legacySlot = data.SLOTS[1]
local originalSnapshot = ApogeePartyHealthBars_S.charSv.keyboardActions.ownership["2"]
...
assert(manager.Reconcile()
        ...
        and ApogeePartyHealthBars_S.charSv.keyboardActions.ownership["2"]
...
for _, slot in ipairs(data.SLOTS) do
    assert(ApogeePartyHealthBars_S.charSv.keyboardActions.ownership["1"][slot.id].previousAction
...
assert(ApogeePartyHealthBars_S.charSv.keyboardActions.ownership["2"] == nil,
...
local recoveryOwnership = ApogeePartyHealthBars_S.charSv.keyboardActions.ownership["2"]
...
assert(recovered and #recoveryFailures == 0
    and not ApogeePartyHealthBars_S.charSv.keyboardActions.ownership["2"].__claimPending,
